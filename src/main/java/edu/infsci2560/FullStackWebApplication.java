...
public class FullStackWebApplication {
    ...
    public static void main(String[] args) {
        ...
        repository.save(new Recipe(1L, "Chocolate Muffin", recipeType.Baker));
        repository.save(new Recipe(2L, "Mojito", recipeType.Alcoholic));
        repository.save(new Recipe(3L, "Hot Wings", recipeType.MeatLover));
    }
}
